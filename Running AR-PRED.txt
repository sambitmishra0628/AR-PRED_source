...
Note: Owing to the random selection of homologs for calculation of residue conservation scores and also due to the random sampling of perturbation points for calculations of dynamic flexibility and perturbation response, there may be some inconsistency in the residue ranking and scoring by AR-PRED in independent runs of the same protein. It is thus, a good idea to consider the average results from multiple AR-Pred runs to get a more accurate prediction.
